...
const SignUpForm = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-8 p-6 bg-white rounded-md shadow-md">
      ...
      <p className='mb-2 text-center'>Have an account? <strong onClick={handleToggle} className='cursor-pointer text-blue-600'>Log in now</strong></p>
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
        <label htmlFor="name" className="text-md font-medium text-gray-600 mb-1 px-0">
            Name
          </label>
          <input
            type="text"
